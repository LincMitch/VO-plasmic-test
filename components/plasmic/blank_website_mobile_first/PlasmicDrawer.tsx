...
import Button from "../../Button"; // plasmic-import: yIH20g9czJcj/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: QfAM-nkavqMr/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_N2O-5hVgo4-3"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__quqkX)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
                ...
                {renderPlasmicSlot({
                  defaultContents: (
                    <Stack__
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__grLeY)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__sVsz3)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__muLg6)}
                    >
                      <Button
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button
                  className={classNames("__wab_instance", sty.button___86Xo)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
