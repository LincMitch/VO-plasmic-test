...
import Label from "../../Label"; // plasmic-import: XlVz03Tgxr1l/component
import TextInput from "../../TextInput"; // plasmic-import: pmZpRVc12nTB/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: JzMQsgDSztcV/component
import Description from "../../Description"; // plasmic-import: N54LNWp3xWEL/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: brxGwrrVaZi8MdDJQRNRHB/projectcss
import sty from "./PlasmicTextField.module.css"; // plasmic-import: QksqoaeWPgvH/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__zwwq1, {
          [sty.freeBoxiconEnd__zwwq1SbogQ]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__zwwq1Sg2Po]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__zwwq1RM5J]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__iOoko, {
            [sty.freeBoxiconStart__iOokoSg2Po]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__iOokorM5J]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___8IiYe)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__eLwd, {
            [sty.freeBoxiconEnd__eLwdsbogQ]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__eLwdSg2Po]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__klhIq)}
                role={"img"}
              />
            ),
