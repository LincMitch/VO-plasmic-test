...
import Checkbox from "../../Checkbox"; // plasmic-import: 63N5aUNdzDbu/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: 8TF3GX9IHJMf/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__tsNoc)}
          >
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__o0UVl)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__z7Lx4)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__rxLhp)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
