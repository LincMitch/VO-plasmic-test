...
import Radio from "../../Radio"; // plasmic-import: po6zyupWopdX/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: kliFoDptqGF8/css
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__yrjM6)}
          >
            <Radio
              className={classNames("__wab_instance", sty.radio___7G4E9)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__dfyb8)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__dxtqR)}
              label={"Option 3"}
              value={"option3"}
            />
          </Stack__>
