...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: po6zyupWopdX/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__l3CiE)}>
        <div className={classNames(projectcss.all, sty.freeBox__lu3Td)} />
      </div>
      {renderPlasmicSlot({
