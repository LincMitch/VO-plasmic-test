...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: zUcM_i8IhuKn/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__mhrU)}
      >
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox___2EMvx)}>
            <div
              className={classNames(
                projectcss.all,
