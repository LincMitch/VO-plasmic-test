...
import SliderThumb from "../../SliderThumb"; // plasmic-import: iuftwnLkvY_1/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: jOuWoDVJE-R0/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__biJe8)}
      >
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__cNvvy)}>
        <div
