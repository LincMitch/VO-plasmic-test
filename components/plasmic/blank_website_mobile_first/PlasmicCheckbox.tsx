...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 63N5aUNdzDbu/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: kZVG0EwljUe-/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: MoSh7x8SSbwa/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__cdwy)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__y4Ion)}
            role={"img"}
          />
        ) : null}
      </div>
